<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"C:\wamp\www\potato\public/../application/index\view\offices\officelist.html";i:1525237934;s:58:"C:\wamp\www\potato\application\index\view\public\head.html";i:1525227111;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="x-body">
    ...
    <xblock>
        <button class="layui-btn" onclick="x_admin_show('添加用户','addofficer')"><i class="layui-icon"></i>添加</button>
    </xblock>
